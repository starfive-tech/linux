...
static const struct jh71x0_clk_data jh7110_sysclk_data[] __initconst = {
	...
	JH71X0_GATE(JH7110_SYSCLK_UART1_APB, "uart1_apb", CLK_IS_CRITICAL, JH7110_SYSCLK_APB0),
	JH71X0_GATE(JH7110_SYSCLK_UART1_CORE, "uart1_core", CLK_IS_CRITICAL, JH7110_SYSCLK_OSC),
	JH71X0_GATE(JH7110_SYSCLK_UART2_APB, "uart2_apb", CLK_IS_CRITICAL, JH7110_SYSCLK_APB0),
	JH71X0_GATE(JH7110_SYSCLK_UART2_CORE, "uart2_core", CLK_IS_CRITICAL, JH7110_SYSCLK_OSC),
