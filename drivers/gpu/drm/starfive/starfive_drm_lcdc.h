...
extern void lcdc_enable_intr(struct starfive_crtc *sf_crtc);
extern void lcdc_disable_intr(struct starfive_crtc *sf_crtc);
extern irqreturn_t lcdc_isr_handler(int this_irq, void *dev_id);
extern void lcdc_int_cfg(struct starfive_crtc *sf_crtc, int mask);
extern void lcdc_config(struct starfive_crtc *sf_crtc, struct drm_crtc_state *old_state, int winNum);
extern int lcdc_win_sel(struct starfive_crtc *sf_crtc, enum lcdc_in_mode sel);
extern void lcdc_dsi_sel(struct starfive_crtc *sf_crtc);
extern void lcdc_run(struct starfive_crtc *sf_crtc, uint32_t winMode, uint32_t lcdTrig);
extern void starfive_set_win_addr(struct starfive_crtc *sf_crtc, int addr);
extern int starfive_lcdc_enable(struct starfive_crtc *sf_crtc);
extern void starfive_lcdc_disable(struct starfive_crtc *sf_crtc);
