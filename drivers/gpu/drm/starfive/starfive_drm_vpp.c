...
void pp_srcfmt_cfg(struct starfive_crtc *sf_crtc, int ppNum, int srcformat, int yuv420Inter, int yuv422_mode,
...
irqreturn_t vpp1_isr_handler(int this_irq, void *dev_id)
{
	...
	starfive_flush_dcache(sf_crtc->dma_addr, sf_crtc->size);
