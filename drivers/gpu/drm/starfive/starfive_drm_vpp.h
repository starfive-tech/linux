...
extern void pp_srcOffset_cfg(struct starfive_crtc *sf_crtc, int ppNum, int yoff, int uoff, int voff);
extern void pp_nxtAddr_load(struct starfive_crtc *sf_crtc, int ppNum, int nxtPar, int nxtPos);
extern void pp_intcfg(struct starfive_crtc *sf_crtc, int ppNum, int intMask);
extern irqreturn_t vpp1_isr_handler(int this_irq, void *dev_id);
extern void pp1_enable_intr(struct starfive_crtc *sf_crtc);
extern void pp_enable_intr(struct starfive_crtc *sf_crtc, int ppNum);
extern void pp_disable_intr(struct starfive_crtc *sf_crtc, int ppNum);
extern void pp_run(struct starfive_crtc *sf_crtc, int ppNum, int start);
extern int starfive_pp_enable(struct starfive_crtc *sf_crtc);
extern int starfive_pp_get_2lcdc_id(struct starfive_crtc *sf_crtc);
extern int starfive_pp_update(struct starfive_crtc *sf_crtc);
extern void vout_disable(struct starfive_crtc *sf_crtc);
extern void vout_reset(struct starfive_crtc *sf_crtc);
extern void dsitx_vout_init(struct starfive_crtc *sf_crtc);
