 ...
 */
#if defined(WLAN_AKM_SUITE_FT_8021X_SHA384)
/* undefine WLAN_AKM_SUITE_FT_8021X_SHA384 if it was defined,
   it was in <net/lib80211.h> for 5.10.6 fedora */
#undef WLAN_AKM_SUITE_FT_8021X_SHA384
#endif
